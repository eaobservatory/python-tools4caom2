...
#************************************************************************
#*
#*   Script Name:    geolocation.py
#*
#*   Purpose:
#*    Low-accuracy routine to calculate (X, Y, Z) coordinates relative to
#*    the center of the Earth, given a position at
...
#*   Functions:
#+
#+    geolocation((longitude, latitude, elevation_meters)
#+       returns an (X, Y, Z) tuple of strings (not floats)
#+           giving the location relative to the center of the Earth in meters
#+
#*
